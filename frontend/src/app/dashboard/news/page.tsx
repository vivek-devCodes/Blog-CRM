...
import Loader, { SkeletonCard, SkeletonTable } from '../../components/ui/Loader';
...
const NewsPage = () => {
  ...
  const fetchNews = async () => {
    try {
      showLoader('Loading news articles...');
      ...
      if (data.success) {
        ...
        toastError(data.message || 'Failed to fetch news articles');
      }
    } catch (error) {
      setError('Failed to fetch news articles');
      toastError('Failed to fetch news articles');
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toastError('Failed to delete news article');
      }
    } catch (error) {
      toastError('Failed to delete news article');
    }
        ...
        <div className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{stats.overview.publishedNews}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{stats.overview.draftNews}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            <div className="px-6 py-4 border-b border-white/20">
              <h3 className="text-lg font-semibold text-gray-900">Recent News Articles</h3>
            </div>
